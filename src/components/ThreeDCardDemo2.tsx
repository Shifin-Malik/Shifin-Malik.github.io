...
>
  Kalaravu is a SvelteKit-based college arts scoreboard that tracks and displays event scores in real-time. It’s designed to be lightweight, responsive, and perfect for cultural festivals and competitions.
</CardItem>
  ...
  Your browser does not support the video tag.
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <CardItem
            translateZ={20}
            as="button"
             href="https://kalaravu.vercel.app/"
