  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
        ...
        >
          Quiz Battle is a fast-paced multiplayer and singleplayer trivia game built with Reactjs. Challenge friends on LAN or test your knowledge solo across various categories with real-time scoring.
        </CardItem>
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <CardItem
            translateZ={20}
            as="a"
            href="https://quiz-battle-demo.vercel.app/"
            target="_blank"
