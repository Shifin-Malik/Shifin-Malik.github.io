...
>
  Notepad is an open-source project built with Svelte that allows users to create, edit, and manage notes efficiently. It emphasizes simplicity and performance, making it a lightweight and effective note-taking solution.
</CardItem>
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <CardItem
            translateZ={20}
            as="button"
             href="https://notpad-enhanced.vercel.app/"
