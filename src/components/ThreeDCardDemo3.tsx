...
>
  Disney is a movie app that provides a platform for streaming and discovering a wide range of films and series. It’s designed to be user-friendly, engaging, and perfect for movie enthusiasts.
</CardItem>
  ...
  Your browser does not support the video tag.
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <CardItem
            translateZ={20}
            as="button"
             href="https://clone-disney-delta.vercel.app/"
