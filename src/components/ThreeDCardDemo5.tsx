  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
        ...
        >
          Foodie is a modern, static ReactJS food delivery website with a clean UI. Designed to showcase restaurants, menus, and promotions, it offers a seamless user experience across all devices.
        </CardItem>
        ...
        <div className="flex justify-between items-center mt-4 ">
          ...
          <CardItem
            translateZ={20}
            as="a"
            href="https://foodie-hub-six.vercel.app/" // ← update with your actual demo link
            target="_blank"
